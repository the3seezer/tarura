...
<form  action="includes/process.php" method="post"  class="form-horizontal form-label-left">
     ...
     <label class="control-label col-md-3 col-sm-3 col-xs-12">Ministry/Organization Name<span class="required">*</span></label>
     <div class="col-md-6 col-sm-6 col-xs-12">
     <input id="orgName" class="form-control col-md-7 col-xs-12"  name="orgName"  required type="text">
     </select>
     </div>
     </div>
     ...
     <input type="submit"  id="send"  class="btn btn-success" name="addOrganization" value="Submit"/>
