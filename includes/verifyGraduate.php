...
//Get Proffesional Details
$getP=$db->getProfessionalByProfId($prof_id);
$rw=$getP->fetch();
$eduLevel=$rw['level'];
$instID=$rw['college'];
$progID=$rw['programme_id'];
$acYear=$rw['year'];
...
<form  action="?pg=grad" method="post"  class="form-horizontal form-label-left">
			  ...
			  <div class="item form-group">
               <label class="control-label col-md-3 col-sm-3 col-xs-12">Enter your College RegNo<span class="required">*</span> </label>
			  ...
			  <!--
			   ...
			   <input type="hidden" name="eduLevel" value="<?php echo $eduLevel; ?>"/>
