...
<!--Application Status:-->
 <div class="item form-group">
 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender">Application Status:<span class="required">*</span></label>
 <div class="col-md-6 col-sm-6 col-xs-12">
 <select name="status" id="mar"  onchange="showRemarks(this.value)" class="form-control" required>
  <option value="">--Select--</option>
  <option value="1">Accept with recommendation</option>
  <option value="2">Accept without recommendation</option>        
 </select> 
</div>
</div>
<!--Remark: -->
...
<input type="submit"  id="send"  class="btn btn-success" name="acceptApp" value="Submit"/>
