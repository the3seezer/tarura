...
<form  action="includes/process.php" method="post"  class="form-horizontal form-label-left">
     ...
     <div class="item form-group">
     <label class="control-label col-md-3 col-sm-3 col-xs-12">Jina la Tarafa<span class="required">*</span></label>
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="tarafa" class="form-control col-md-7 col-xs-12" name="tarafa"  required type="text">
     </div>
     </div>
     ...
     <input type="submit"  id="send"  class="btn btn-success" name="addTARA" value="Submit"/>
...
$("select#region_id").change(function () {
        ...
        if (selectedRegionTypeName !== "All") {
            ...
            let _url = "lib/districtByReg1.php?id=" + selectedRegionType;
            $.ajax({
