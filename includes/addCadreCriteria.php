...
<form action="includes/process.php" method="post" class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select id="criteria" class="form-control col-md-7 col-xs-12" name="criteria"
        ...
        <div class="col-md-2 col-sm-2 col-xs-12">
            <input id="credit" class="form-control col-md-7 col-xs-12" name="credit"
                   placeholder="Credit" required="required" type="text" pattern="[0-9]+"
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
            <input type="submit" id="send" class="btn btn-success" name="addCriteriaCadre" value="Submit"/>
