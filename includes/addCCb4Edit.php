...
<form  action="includes/process.php" method="post"  class="form-horizontal form-label-left">
	 ...
	 <select id="criteria" class="form-control col-md-7 col-xs-12" name="criteria<?php echo $room; ?>" required="required">
      <option value="">--Select--</option>
	  <?php
     ...
     <input id="credit" class="form-control col-md-7 col-xs-12" name="credit<?php echo $room; ?>" placeholder="Credit" required="required" type="number">
     </div>
