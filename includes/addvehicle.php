...
<form action="../include/process.php" method="post" class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <input id="vehicle" class="form-control col-md-12 col-xs-12 " name="RegNo" require type="text">
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <input id="mobileno" class="form-control col-md-12 col-xs-12 " name="mobileno" require type="text">
        </div>
    </div>
    <div class="item form-group">
        <label class="control-label col-md-12 col-sm-12 col-xs-12">Date<span class="required">*</span></label>
        <div class="col-md-12 col-sm-12 col-xs-12">
            <input id="date" class="form-control col-md-12 col-xs-12 " name="date" require type="text">
        </div>
        <div class="item form-group">
            <label class="control-label col-md-12 col-sm-12 col-xs-12">Date<span class="required">*</span></label>
            <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">Jina la Mtaa/Kijiji<span
                    class="required">*</span></label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="vehicle" class="form-control col-md-7 col-xs-12" name="vehicle" required type="text">
            </div>
        </div>
