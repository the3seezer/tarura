...
<form  action="../includes/process.php" method="post"  class="form-horizontal form-label-left">
     ...
     <div class="item form-group">
     <label class="control-label col-md-3 col-sm-3 col-xs-12">Jina la Kata<span class="required">*</span></label>
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="Kata" class="form-control col-md-7 col-xs-12" name="Kata"  required type="text">
     </div>
     </div>
     ...
     <input type="submit"  id="send"  class="btn btn-success" name="addKATA" value="Submit"/>
...
$("select#region_id").change(function () {
        ...
        if (selectedRegionTypeName !== "All") {
            ...
            let _url = "../lib/districtByReg2.php?id=" + selectedRegionType;
            $.ajax({
