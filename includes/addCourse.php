...
<form action="includes/process.php" method="post" class="form-horizontal form-label-left">
    ...
    <div class="item form-group">
        <label class="control-label col-md-2 col-sm-2 col-xs-12">Course Name<span class="required">*</span></label>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="abbreviation" class="form-control col-md-7 col-xs-12" name="abbreviation"
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
            <input type="submit" id="send" class="btn btn-success" name="addNewCourse" value="Submit"/>
