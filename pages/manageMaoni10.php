    ...
    <div class="row">
     ...
     <label >Aina ya Kikao/Kamati<span class="required">*</span></label>
          ...
          <select name="aina" id="jinai" class="form-control col-md-7 col-xs-12" required onchange="loadVikao(this.value)">
		   ...
		   <?php if($_SESSION['kikawali'] =="Yes")
           echo '<option value="I">(i) Kikao cha Awali (Kabla ya Kura za Maoni)</option>';
	         if($_SESSION['kikpili'] =="Yes")
		   echo '<option value="II">(ii) Kikao cha Pili (Kabla ya Kura za Maoni)</option>';
	          if($_SESSION['kiktatu'] =="Yes")
		   echo '<option value="III">(iii) Kikao cha Tatu (Kabla ya Kura za Maoni)</option>';
	          if($_SESSION['kamatikz'] =="Yes")
		   echo '<option value="IV">(iv) Kamati Maalumu ya Halmashauri Kuu ya CCM ya Taifa Zanzibar</option>';
	          if($_SESSION['kikuteuzi'] =="Yes")
		   echo '<option value="V">(v) Kikao cha Uteuzi wa Awali</option>';
		   ?>
          </select>
