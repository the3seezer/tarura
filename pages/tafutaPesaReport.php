...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Wagombea, Fedha Zilizolipwa </h3>
    </div>
</div>
<div class="row">
                  ...
                  <form method="post" action="manageReportMapato.php" class="form-horizontal form-label-center"  target="_blank">
                            <input id="idd" type="hidden" name="idd" value="<?php echo $id;?>">
         <div class="col-lg-12">
	       <div class="panel panel-default">
                      <div class="panel-heading">
                              <h4> <strong>Tafuta Wagombea, Fedha </strong></h4>
                       </div>
