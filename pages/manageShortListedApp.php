<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Shortlisted Applicants</h1>
    </div>
</div>
<div class="row">
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        ...
                        <?php if ($_SESSION['permissions']['can_shortlist'] == 'YES') { ?>
                            <span style="float:right;">
                                <button class="btn btn-success" data-toggle="modal" data-target="#shortlist" data-id="<?php echo $_SESSION['userid']; ?>" id="getadduser"><i class="fa fa-plus-square"></i>Shortlist</button>
                                </p>
                            </span>
                        <?php }; ?>
