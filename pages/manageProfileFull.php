...
$db->connect();
$idd = $_SESSION['userid'];
$sellaa = $db->selectUbungeUser($idd);
$rwaa = $sellaa->fetch();
$id = $rwaa['ubunge_id'];
...
<div class="row">
    <div class="row">
	  ...
	  //`ishimtaa`, `uraia`, `ainayauraia`, `nambayahati`, `ubunge_id`  FROM `ubunge WHERE 1
				...
				<div class="panel panel-default">
                <div class="panel-heading"><strong>WAZAZI WA MGOMBEA</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">
...
<div class="panel panel-default">
                <div class="panel-heading"><strong>URAIA WA MGOMBEA</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">						
                             <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                            <thead>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><strong>ELIMU YA MGOMBEA</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
			...
			<div class="panel panel-default">
                <div class="panel-heading"><strong>UANACHAMA</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
			...
			<div class="panel panel-default">
                <div class="panel-heading"><strong>UONGOZI NA MAADILI</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
            <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                    ...
                    <div class="panel-heading"><strong>VYETI VYA MUOMBAJI</strong></div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="dataTable_wrapper">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                         ...
                         <?php 
						 $sela = $db->seachPicha($id);
						 while($rwe = $sela->fetch())
							   {
								   ...
								   ?>
                                    ...
                                    <tr class="odd gradeX">
                                       ...
                                       <td><a href="../includes/viewDocuments.php?id=<?php echo $rwe['picha_id']; ?>&ext=<?php echo $rwe['extension']; ?>" target="_blank">
                                        
                        <button class="btn btn-primary btn-outline"><i class="fa fa-list fa fw"></i>&nbsp;View</button>
                    </td>
                                    </tr>
							   <?php } ?>
                            </tbody>
