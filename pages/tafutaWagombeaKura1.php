...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Kura za Mgombea</h3>
    </div>
</div>
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
                  ...
                  <form method="post" action="?pg=bKuramgombeaPost" class="form-horizontal form-label-left" novalidate>
                            <input id="idd" type="hidden" name="idd" value="<?php echo $id;?>">
         <div class="col-lg-12">
	       <div class="panel panel-default">
                      <div class="panel-heading">
                              <h4> <strong> Tafuta Mgombea</strong></h4>
                       </div>
