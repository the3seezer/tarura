...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Report ya Orodha ya Wagombea</h3>
    </div>
</div>
                  ...
                  <form method="post" action="manageReportWago.php" class="form-horizontal form-label-center" target="_blank">
