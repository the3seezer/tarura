    ...
    <div class="row">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                      ...
                      <form method="post" action="includes/process.php" class="form-horizontal form-label-left">
                            <?php if($idds1=="kata")
							{?>
							<input id="idd" type="hidden" name="idd" value="<?php echo $idds2;?>">
							<?php }else
							{?>
	 ...
	 <div class="panel panel-default">
                  <div class="panel-heading">
						 ...
						 <h5> <strong> (a) VIKAO VYA UTEUZI BAADA YA KURA ZA MAONI</strong></h5>
                            </div>
             <div class="panel-body">
			
			<div class="col-lg-12">
	 <div class="form-group">
	  <label> Ngazi Wagombea<span class="required">*</span></label>
	          <select name="ngazi" id="ngazi" class="form-control col-md-7 col-xs-12" required>
             <option value="">--Chagua--</option>
			<?php if($idds1=="kata")
			{?>
		    <option>Udiwani</option>
			<?php
			}else
			{	
			?>
			<option>Ubunge</option>
		   <?php
			}	
			?>
			</select>
	 ...
	 <div class="form-group">
     <label >Idadi ya Kura<span class="required">*</span></label>
     
         <input id="idadi" class="form-control col-md-7 col-xs-12" name="idadi"  required type="text">
     
     </div>
	 
	 <div class="form-group">
     <label >Kura Zilizoharibika<span class="required">*</span></label>
     
         <input id="haribika" class="form-control col-md-7 col-xs-12" name="haribika"  required type="text">
     
     </div>
	 <div class="form-group">
     <label >Kura Halali<span class="required">*</span></label>
     
         <input id="halali" class="form-control col-md-7 col-xs-12" name="halali"  required type="text">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="AddJumla" type="submit" class="btn btn-primary" name="AddJumla">Submit</button>
