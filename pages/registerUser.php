...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Kusajili Mtumiaji wa Mfumo</h3>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <strong>ONGEZA MTUMIAJI</strong> 

                </div>
                <!--/.panel-heading -->
                <div class="panel-body">
                    <div class="dataTable_wrapper">
					<span style="float:right;"> <p><a href="?pg=regUser"><button class="btn btn-success"><i class="fa fa-fast-backward fa-fw"></i> Rudi</button></a>
...
<div class="col-lg-12">
     ...
     <label >Jina la Mtumiaji<span class="required">*</span></label>
     
         <input id="jina" class="form-control col-md-7 col-xs-12" name="jina"  required type="text">
     
     </div>
	 <div class="form-group">
     <label >Namba ya Kadi Mpya ya CCM<span class="required">*</span></label>
     
         <input id="kadi" class="form-control col-md-7 col-xs-12" name="kadi"  required type="text">
     
     </div>
	 <div class="form-group">
     <label >Email<span class="required">*</span></label>
     
         <input id="email" class="form-control col-md-7 col-xs-12" name="email"  required type="text">
   ...
   <div class="form-group">
     <label >Password<span class="required">*</span></label>
         ...
         <input id="password" class="form-control col-md-7 col-xs-12" name="password"  required type="password">
			...
			<div class="form-group">
				<label>Aina ya Mtumiaji<span class="required">*</span></label>
			 
				  <select name="aina" id="aina" class="form-control col-md-7 col-xs-12" required onchange="UserAina(this.value)" >
				       <option value="">--chagua--</option> 
					   <option value="Kiongozi">Kiongozi</option>
					   <option value="Mgombea">Mgombea</option>
					   <option value="Tehama">Tehama</option>
				  </select>
			 </div>
			 
			
			 <div id="UserAinaPrivillege"></div>
							...
							<div class="ln_solid"></div>
                             ...
                             <div class="col-md-6 col-md-offset-3">
                                    <button id="AddMtumia" type="submit" class="btn btn-primary" name="AddMtumia">Submit</button>
