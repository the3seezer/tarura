...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Uthibitisho wa Taarifa za Wagombea</h3>
    </div>
</div>
                  ...
                  <form method="post" action="?pg=bMaoniPost" class="form-horizontal form-label-left" novalidate>
	         ...
	         <div id="WilayaContainer"></div>
				  ...
				  <div class="form-group">
                             <div class="col-md-6 col-md-offset-3">
                                    <button id="AddThib" type="submit" class="btn btn-primary" name="AddThib">Submit</button>
