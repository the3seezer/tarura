...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">SEHEMU YA PILI: Uanachama </h3>
    </div>
</div>
<div class="row">
    ...
    <div class="row">
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                      ...
                      <form method="post" action="includes/process.php" class="form-horizontal form-label-left" novalidate>
                            <input id="idd" type="hidden" name="idd" value="<?php echo $idd;?>">
         <div class="col-lg-12">
	       <div class="panel panel-default">
							...
							<div class="form-group">
                                <label> Namba ya Kadi ya Zamani <span class="required">*</span> </label>
                                    ...
                                    <input id="kadizamani" class="form-control col-md-7 col-xs-12" name="kadizamani" required="required" type="text" value="<?php echo $zamakadi;?>">
                                </div>
     ...
     <label >Tawi<span class="required">*</span></label>
          ...
          <input id="tawi" class="form-control col-md-7 col-xs-12" name="tawi"  required type="text" value="<?php echo $rwa['zamakaditawi'];?>">
       ...
       <input id="kadimpya" class="form-control col-md-7 col-xs-12" name="kadimpya"
	   required="required" type="text" value="<?php echo $rwa['mpyakadi'];?>">
     ...
     <label>Tawi<span class="required">*</span></label>
          ...
          <input id="tawim" class="form-control col-md-7 col-xs-12" name="tawim" 
		  required type="text" value="<?php echo $rwa['mpyatawi'];?>">
     </div>
                     ...
                     <!--hadi-->
                            <div class="form-group">
                                <label for="name">Umelipa Ada Hadi lini?<span class="required">*</span> </label>
                                    ...
                                    <input id="hadi" class="form-control col-md-7 col-xs-12" placeholder="" name="hadilini" 
									required="required" type="text" value="<?php echo $rwa['mpyahadilini'];?>">
	              ...
	              <!--kadiUWT-->
                            <div class="form-group">
                                <label for="last">Namba ya Kadi ya UWT/UVCCM/WAZAZI <span class="required">*</span> </label>
                                    ...
                                    <input id="kadijumuia" class="form-control col-md-7 col-xs-12" name="kadijumuia" required="required" 
									type="text" value="<?php echo $rwa['jumuiyakadi'];?>">
                                </div>
     ...
     <div class="form-group">
       <label>Umelipa Ada ya Uanachama Hadi Lini<span class="required">*</span></label>
     
          <input id="hadilinivc" class="form-control col-md-7 col-xs-12"
		  name="hadilinivc"  required type="text" value="<?php echo $rwa['jumuiyahadilini'];?>">
     ...
     <div class="form-group">
       <label>Tawi Lako ya CCM Kwa Sasa<span class="required">*</span></label>
          ...
          <input id="tawilako" class="form-control col-md-7 col-xs-12"
		  name="tawilako"  required type="text" value="<?php echo $rwa['tawijina'];?>">
     </div>
     ...
     <div class="form-group">
       <label>Jina la Mwenyekiti Wako<span class="required">*</span></label>
          ...
          <input id="mwk" class="form-control col-md-7 col-xs-12" name="mwk" 
		  required type="text" value="<?php echo $rwa['tawimwkjina'];?>">
	...
	<div class=" form-group">
       <label>Kama ndio taja chama hicho, Muda uliotumikia na Wadhifa<span class="required">*</span></label>
          ...
          <input id="tajachama" class="form-control col-md-7 col-xs-12"
		  name="tajachama"  required type="text" value="<?php echo $rwa['chamamaelezo'];?>">
     </div>
     </div>
	 </div>
     </div>
	 ...
	 <div class="form-group">
       <label >Kama ndio eleza aina ya kodi na adhabu uliyopewa na Mahakama<span class="required">*</span></label>
          ...
          <input id="adhabu" class="form-control col-md-7 col-xs-12" name="adhabu" 
		  required type="text" value="<?php echo $rwa['kwepakodimaelezo'];?>">
     </div>
     </div>
	 </div>
     </div>
	 ...
	 <div class="form-group">
       <label>Eleza Uzoefu Wako Katika Chama/Jumuiya<span class="required">*</span></label>
          ...
          <input id="uzoefu" class="form-control col-md-7 col-xs-12"
		  name="uzoefu"  required type="text" value="<?php echo $rwa['chamauongozi'];?>">
	 ...
	 <div class="form-group">
       <label>Eleza Mchango Wako Katika Kuimarisha Uhai wa Chama<span class="required">*</span></label>
          ...
          <input id="mchango" class="form-control col-md-7 col-xs-12" 
		  name="mchango"  required type="text" value="<?php echo $rwa['chamamchango'];?>">
     </div>
     </div>
	 </div>
     </div>
	 ...
	 <div class="form-group">
       <label">Eleza Kazi Unayofanya Kupata Kipato<span class="required">*</span></label>
          ...
          <input id="kazi" class="form-control col-md-7 col-xs-12" name="kazi" 
		  required type="text" value="<?php echo $rwa['kazikipato'];?>">
	 ...
	 <div class="form-group">
       ...
       <input id="jinaiadhabu" class="form-control col-md-7 col-xs-12" 
	   name="jinaiadhabu" type="text" value="<?php echo $rwa['kosajinaimaelezo'];?>">
	 ...
	 <div class="form-group">
       ...
       <label >Kama ndio Taja Kosa hilo Adhabu Uliyopewa na Tarehe<span class="required">*</span></label>
          ...
          <input id="nidhamuadhabu" class="form-control col-md-7 col-xs-12" 
		  name="nidhamuadhabu" type="text" value="<?php echo $rwa['kosamaadilimaelezo'];?>">
     </div>
	 ...
	 <div class="panel panel-default">
	  ...
	  <label> Thibitisha muombaji<span class="required">*</span></label>
       ...
       <label> Tarehe ya kuthibitisha muombaji<span class="required">*</span></label>
          ...
          <input id="muombajithibitarehe" class="form-control" 
		  name="muombajithibitarehe"  required type="text" value="<?php echo $rwa['muombajithibitishatarehe'];?>">
            ...
            <div class="ln_solid"></div>
                        <div class="form-group">
                             <div class="col-md-6 col-md-offset-3">
                                    <button id="EditUchama" type="submit" class="btn btn-primary" name="EditUchama">Submit</button>
