	  ...
	  // `gmkoa_id`, `dob`
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="left"><a href="?pg=bChama&id=<?php echo $rw['ubunge_id']; ?>"><button class="btn btn-danger"><i class="fa fa-plus-square"></i>Ongeza</button></a></td>
                                        <td align="left"><a href="?pg=pProfile&id=<?php echo $rw['ubunge_id']; ?>"><button class="btn btn-danger"><i class="fa fa-plus-square"></i>Angalia</button></a></td>
                                    </tr>
                                <?php $i++;
                                } ?>
                            </tbody>
