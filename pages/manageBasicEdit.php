...
<div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="school" class="form-control col-md-7 col-xs-12" name="school" required type="text" value="<?php echo $chuo;?>">
        </div>
    </div>
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select class="form-control" id="year" name="year" required>
				...
				{
					?>
                    <option selected="selected"><?php echo date('Y') - $i; ?></option>
            <?php
				}
				else
				{
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
      <textarea name="maelezo" cols="60" rows="2" class="validate[required] form-control" ><?php echo $maelezo;?></textarea>
    </div>
  </div>
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
            <button id="EditEducation" type="submit" name="EditEducation" class="btn btn-success">Submit</button>
