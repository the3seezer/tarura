...
*/
        ...
        elseif ($getAp->rowCount() < 1) {
            ...
            <div class="panel panel-primary">
                <div class="panel-heading"> Make Application by selecting facility and cadre below. You can select up to
                    three choices.
                </div>
                <div class="panel-body">
                    ...
                    <form action="includes/process.php" method="post" class="form-horizontal form-label-left">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <select id="cadre" class="form-control col-md-7 col-xs-12" name="cadre1"
                                        required="required">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <select id="cadre1" class="form-control col-md-7 col-xs-12" name="cadre2"
                                        required="required">
                                    <option value="">--Cadre--</option>
                                </select>
                            </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-5 col-sm-5 col-xs-12">
                                <select id="cadre2" class="form-control col-md-7 col-xs-12" name="cadre3"
                                        required="required">
                                    <option value="">--Cadre--</option>
                                </select>
                            </div>
...
<!--                            <th>Board Registration <br/>Verification</th>-->
                        ...
                        while ($row = $getAp->fetch()) {
                            ...
                            if ($status == "Pending") {
                                ...
                                <!--
	   <td align="left"><a href="#deleteApplication" class="btn btn-danger btn-xs" data-toggle="modal" data-id="<?php echo $app_id; ?>" id="getdeleteApplication"><i class="fa fa-trash"></i>Delete</a>
       </td>
	   -->
                                </tr>
