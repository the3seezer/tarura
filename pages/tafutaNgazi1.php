...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Idadi ya Kura, Zilizoharibika, na Halali</h3>
    </div>
</div>
<div class="row">
    ...
    <div class="row">
        <div class="col-lg-12">
                  ...
                  <form method="post" action="?pg=bKurajumlaPost" class="form-horizontal form-label-left" novalidate>
                            <input id="idd" type="hidden" name="idd" value="<?php echo $id;?>">
         <div class="col-lg-12">
	       <div class="panel panel-default">
                      <div class="panel-heading">
                              <h4> <strong> Tafuta Kata au Jimbo</strong></h4>
                       </div>
