...
function loadUteuzi(str) {
             //alert('test');
                ...
                xmlhttp.open("GET", "lib/uteuzi.php?q=" + str, true);
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" >Taarifa za Kura za Mgombea</a>
							</h4>
						</div>
...
//`jinamwanzo`, `jinakati`, `jinamwisho`, `nafasi`, `gjimbo_id`, `gwilaya_id`,
	  // `gmkoa_id`, `dob`
					         ...
					         <div class="panel panel-info">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" >Taarifa za Mapendekezo</a>
                                                </h4>
                                            </div>
					...
					<div class="row">
                            ...
                            <thead>
                                <tr>
									...
									<th>Maelezo ya Maoni/Uteuzi</th>
                                    <th>Jina la Katibu</th>
									<th>Ngazi ya Katibu</th>
                                    <th>Tarehe ya Maoni</th>
                            ...
                            <tbody>
                                ...
                                $sel = $db->UteuziMgombea($id);
                                while ($rw2 = $sel->fetch()) {
//`ainavikao`, `amekubalika`, `maelezoyamaoni`, `jinalakatibu`, `ngaziyakatibu`, `tareheyakikao`, `ubunge_id`, 
	//`uteuzi_id`
                                    $aina = $rw2['ainavikao'];
                                    $hali = $rw2['amekubalika'];
                                    $maoni = $rw2['maelezoyamaoni'];
                                    $jina = $rw2['jinalakatibu'];
                                    $ngazi = $rw2['ngaziyakatibu'];
                                    $tarehe = $rw2['tareheyakikao'];

                                   if($aina=="I")
									   $ainna ="Kikao cha Ngazi ya Awali";
								   elseif($aina=="II")
									   $ainna ="Kikao cha Ngazi ya Pili";
								   elseif($aina=="III")
									   $ainna ="Kikao cha Ngazi ya Tatu";
								   elseif($aina=="IV")
									   $ainna ="Kamati Maalumu ya Halmashauri Kuu ya CCM ya Taifa Zanzibar";
								   elseif($aina=="V")
									   $ainna ="Kikao cha Kamati Kuu ya Halmashauri Kuu ya CCM ya Taifa";
								   elseif($aina=="VI")
									   $ainna ="Kikao cha Halmashauri Kuu ya CCM ya Taifa(Uteuzi wa Mwisho)";
                                ?>
                                    <tr class="odd gradeX">
                                        
                                        <td><?php echo $ainna; ?></td>
                                        
                                        <td><?php echo $hali; ?></td>
                                        
										<td><?php echo $maoni; ?></td>
                                        <td><?php echo $jina; ?></td>
	 ...
	 <div class="panel panel-default">
                  <div class="panel-heading">
						 ...
						 <h5> <strong> (C) MAONI NA MAPENDEKEZO YA VIKAO VYA UTEUZI BAADA YA KURA</strong></h5>
                            </div>
             <div class="panel-body">
			<div class="col-lg-12">
	 
	 <div class="form-group">
     <label >Aina ya Kikao<span class="required">*</span></label>
     
          <select name="aina" id="aina" class="form-control col-md-7 col-xs-12" required onchange="loadUteuzi(this.value)">
          <option value="">--Chagua--</option>
           <option value="I">(i) Kikao cha Ngazi ya Awali</option> 
		   <option value="II">(ii) Kikao cha Ngazi ya Pili</option>
		   <option value="III">(iii) Kikao cha Ngazi ya Tatu </option>
		   <option value="IV">(iv) Kamati Maalumu ya Halmashauri Kuu ya CCM ya Taifa Zanzibar</option>
		   <option value="V">(v) Kikao cha Kamati Kuu ya Halmashauri Kuu ya CCM ya Taifa</option>
		   <option value="VI">(vi) Kikao cha Halmashauri Kuu ya CCM ya Taifa(Uteuzi wa Mwisho)</option>
          </select>
                          ...
                          <div class="ln_solid"></div>
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="AddUchama" type="submit" class="btn btn-primary" name="AddUteuzi">Submit</button>
