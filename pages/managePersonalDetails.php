...
<script >
        function loadKATA(str) {
                ...
                xmlhttp.open("GET", "lib/districtByMg.php?q=" + str, true);

                xmlhttp.send();
            }
			function loadWilayaMg(str) {
                ...
                xmlhttp.open("GET", "lib/districtByMg1.php?id=" + str, true);

                xmlhttp.send();
            }
			
			function loadJimboMg(str) {
                ...
                xmlhttp.open("GET", "lib/jimboByMg.php?id=" + str, true);
    ...
    <div class="row">
                      ...
                      <form method="post" action="includes/process.php" class="form-horizontal form-label-left" >
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="first" class="form-control col-md-7 col-xs-12" name="first" required type="text" >
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="simu" class="form-control col-md-7 col-xs-12" name="simu" required="required" type="text" data-validate-length-range="2,50" value="<?php if (isset($_SESSION['formData'])) {
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="email" class="form-control col-md-7 col-xs-12" name="email" required="required" type="text" data-validate-length-range="2,50" value="<?php if (isset($_SESSION['formData'])) {
                                                                                                                                                                                            print_r($_SESSION['formData']['lastname']);
                                                                                                                                                                                        } ?>">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="fedha" class="form-control col-md-7 col-xs-12" name="fedha" required="required" type="text"  >
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="control" class="form-control col-md-7 col-xs-12" name="control" required="required" type="text" >
                                </div>
                            </div>
							<div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last">Namba ya NIDA<span class="required">*</span> </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="nida" class="form-control col-md-7 col-xs-12" name="nida" required="required" type="text" >
                                </div>
                            </div>
                            <!--Nafasi-->
	   ...
	   <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Mkoa Anakogombea<span class="required">*</span></label>
         <div class="col-md-6 col-sm-6 col-xs-12">
          <select name="region_id" id="region" class="form-control col-md-7 col-xs-12" required onchange="loadWilayaMg(this.value)">
          <option value="">--Chagua--</option>
          <?php
...
<!--District Name-->
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="mtaa" class="form-control col-md-7 col-xs-12" name="mtaa"  required type="text">
     </div>
     </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="baba" class="form-control col-md-7 col-xs-12" placeholder="" name="baba" required="required" type="text" data-validate-length-range="4,50" value=""><span id="status"></span>
                                </div>
                            </div>
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="mtaababa" class="form-control col-md-7 col-xs-12" name="mtaababa"  required type="text">
     </div>
     </div>
    ...
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="kuzaliwababa" class="form-control col-md-7 col-xs-12" name="kuzaliwababa"  required type="text">
     </div>
     </div>
					...
					<!--Mama-->
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="mama" class="form-control col-md-7 col-xs-12" placeholder="" name="mama" required="required" type="text" data-validate-length-range="4,50" value=""><span id="status"></span>
                                </div>
                            </div>
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="mtaamama" class="form-control col-md-7 col-xs-12" name="mtaamama"  required type="text">
     </div>
     </div>
    ...
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="kuzaliwamama" class="form-control col-md-7 col-xs-12" name="kuzaliwamama"  required type="text">
     </div>
     </div>		
    ...
    <div class="item form-group">
     ...
     <div class="col-md-6 col-sm-6 col-xs-12">
          <input id="mtaaishi" class="form-control col-md-7 col-xs-12" name="mtaaishi"  required type="text">
     </div>
     </div>		
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="AddUbunge" type="submit" class="btn btn-primary" name="AddUbunge">Submit</button>
