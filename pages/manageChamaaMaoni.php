	  ...
	  // `gmkoa_id`, `dob`
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="left"><button class="btn btn-danger btn-outline" data-toggle="modal" data-target="#roff" data-id="<?php echo $rw['ubunge_id']; ?>" id="getroff"><i class="fa fa-plus-square"></i> Ongeza Maoni</button></td>
                                        <!--<td align="left"><a href="?pg=bMgProfile&id="><button class="btn btn-info"><i class="fa fa-plus-square"></i>Angalia Profile</button></a></td> -->
                                    <td>
									<button class="btn btn-warning btn-outline" data-toggle="modal" data-target="#Profiles10" data-id="<?php echo $rw['ubunge_id']; ?>" id="getprofiles10"><i class="fa fa-camera-retro"></i> Maoni</button></td>
									
									<td><button class="btn btn-info btn-outline" data-toggle="modal" data-target="#Profiles" data-id="<?php echo $rw['ubunge_id']; ?>" id="getprofiles"><i class="fa fa-camera-retro"></i> Profile</button>
									</td>
									</tr>
                                <?php $i++;
                                } ?>
