...
<html lang="en">
    <head>
        ...
        <title>Orodha ya Wagombea</title>
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td align='center'><strong>Orodha ya Wagombea</strong></td></tr>
	
	<tr><td align="right">&nbsp;<button class="btn btn-outline btn-info" onclick="window.print();return false;" ><i class="fa fa-print fa "></i>Print</button></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr> 
	<td>
<div class="row">
	  ...
	  // `gmkoa_id`, `dob`
                                ...
                                ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="left"><a href="?pg=profile&id=<?php echo $rw['ubunge_id']; ?>"><button class="btn btn-outline btn-danger"><i class="fa fa-plus-square"></i>Profile</button></a></td>
