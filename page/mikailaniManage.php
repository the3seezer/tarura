            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <thead>
                            ...
                            <?php
                            $i = 1;
							//`ilani_id`, `mwakafedha`, `chakufanya`, `kipimo`, `mafanikio`, `gharama_tshs`, `mkati_id`
                            $sel = $db->selectMikaIlani();
                            while ($row = $sel->fetch()) {
