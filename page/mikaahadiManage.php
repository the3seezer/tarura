                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                            $i = 1;
							//`ahadi_id`, `mwakafedha`, `chakufanya`, `kipimo`, `mafanikio`, `gharama_tshs`, `mkatiahad_id``
                            $sel = $db->selectMikaAhadi();
                            while ($row = $sel->fetch()) {
                                
                                ?>
                                            <tr class="odd gradeX">
                                                <td><?php echo $i; ?></td>
                                                <td><?php echo strtoupper($row['mwakafedha']); ?></td>
                                                <td><?php echo strtoupper($row['chakufanya']); ?></td>
                                                <td><?php echo strtoupper($row['kipimo']); ?></td>
                                                <td><?php echo strtoupper($row['mafanikio']); ?></td>
                                                <td><?php echo strtoupper($row['gharama_tshs']); ?></td>
                                                <td><?php echo strtoupper($row['ahadi_id']); ?></td>
                                                <td align="left">
                                                    <a href="#editMTAA" class="btn btn-primary btn-xs"
                                                        data-toggle="modal"
                                                        data-id="<?php echo $row['mkatiahad_id']; ?>"
