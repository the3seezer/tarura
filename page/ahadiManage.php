            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <thead>
                            ...
                            <?php
                            $i = 1;
							//`ngazi`, `ngazi_id`, `aina`, `maelezo`, `mwaka`, `hali`, `changa_id`, `ahadi_id`
                            $sel = $db->selectAhadi();
                            while ($row = $sel->fetch()) {
                                ...
                                <tr class="odd gradeX">
									...
									<td><?php echo strtoupper($row['ngazi_id']); ?></td>
									<td><?php echo strtoupper($row['aina']); ?></td>
                                    <td><?php echo strtoupper($row['maelezo']); ?></td>
									<td><?php echo strtoupper($row['mwaka']); ?></td>
                                    <td><?php echo strtoupper($row['changa_id']); ?></td>
                                    <td align="left">
                                        <a href="#editMTAA" class="btn btn-primary btn-xs" data-toggle="modal"
                                           data-id="<?php echo $row['ahadi_id']; ?>"
                                           id="geteditMTAA"><i class="fa fa-edit"></i>Edit</a>
                                    </td>

                                    <td align="left"><a href="#deleteMTAA" class="btn  btn-danger btn-xs"
                                                        data-toggle="modal" data-id="<?php echo $row['ahadi_id']; ?>"
