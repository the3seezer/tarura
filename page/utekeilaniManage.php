            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <thead>
                            ...
                            $sel = $db->selectUtekeilani();
                            while ($row = $sel->fetch()) {
                                
                                ?>
                                <tr class="odd gradeX">
                                    <td><?php echo $i; ?></td>
									<td><?php echo strtoupper($row['mikailani_id']); ?></td>
