...
<html lang="en">
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td align='center'><strong>Orodha ya Wagombea, Matokeo, na Uteuzi</strong></td></tr>
...
//`jinamwanzo`, `jinakati`, `jinamwisho`, `nafasi`, `gjimbo_id`, `gwilaya_id`,
	  // `gmkoa_id`, `dob`
									...
									$getkurajumla = $db->singleUteuzii($id);
                                    $rwrt = $getkurajumla->fetch();
                                    $uteuzi = $rwrt['amekubalika'];
